...
/**
 * Full gradient card with title, description and children
 * @param param0 
 * @returns 
 */
export const MainMenusGradientCard = ({
  ...
  return (
    ...
    >
      {withArrow && (
        <i className="fa-solid fa-arrow-up-right-from-square absolute top-2 right-2 z-10 size-5 translate-y-4 text-neutral-700 opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100 dark:text-neutral-300 " />
      )}
      <div
        className={cn(
